...
model ThermalZoneVariableCapacity
...
protected
  ...
  Buildings.Utilities.Psychrometrics.Phi_pTX relHum "Relative humidity"
    annotation (Placement(transformation(extent={{156,12},{176,32}})));
  Buildings.Controls.OBC.CDL.Continuous.Division X_w
...
end ThermalZoneVariableCapacity;
