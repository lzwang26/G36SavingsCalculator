...
model FloorDetailed_ChangeV
  "Model of a floor of the building with detailed zoning"
  ...
  parameter Modelica.SIunits.Volume Vzone7=2040.21;
  ...
  DetailedZoning.BaseClasses.ZoneVAV_ChangeV zoneVAV7(
  ...
  Modelica.Fluid.Sensors.Temperature temperature(redeclare final package Medium =
               MediumA)
